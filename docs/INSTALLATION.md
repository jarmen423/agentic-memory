...
openclaw agentic-memory doctor --hosted --backend-url https://your-backend.example.com
openclaw agentic-memory setup --hosted --backend-url https://your-backend.example.com
...
- `docs/openclaw/guides/PRIVATE_BETA_QUICKSTART.md (private repo only)`
- `docs/openclaw/DEPLOYMENT_RUNBOOK.md (private repo only)`
- `docs/openclaw/BETA_ROLLOUT.md (private repo only)`
...
python -m agentic_memory.cli status --json
python -m agentic_memory.cli index --json
```
...
- `https://your-mcp.example.com/publication/agentic-memory`
- `https://your-mcp.example.com/publication/privacy`
- `https://your-mcp.example.com/publication/terms`
- `https://your-mcp.example.com/publication/support`
- `https://your-mcp.example.com/publication/dpa`
