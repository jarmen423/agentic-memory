...
python -m agentic_memory.cli --help
```
...
- `/path/to/your/repo\.codememory\config.json`
...
- `/path/to/your/repo\packages\am-openclaw\README.md`
- `/path/to/your/repo\docs\openclaw\guides\PRIVATE_BETA_QUICKSTART.md`
