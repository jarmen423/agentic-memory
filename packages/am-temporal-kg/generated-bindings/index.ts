...
const tablesSchema = __schema({
  edge: __table({
    ...
    indexes: [
      ...
      { name: 'project_obj_pred_idx', algorithm: 'btree', columns: [
        'projectId',
        'objId',
        'pred',
      ] },
      { name: 'project_subj_pred_idx', algorithm: 'btree', columns: [
        'projectId',
        'subjId',
        'pred',
      ] },
      { name: 'project_valid_from_idx', algorithm: 'btree', columns: [
        'projectId',
        'validFromUs',
      ] },
      { name: 'project_valid_to_idx', algorithm: 'btree', columns: [
        'projectId',
        'validToUs',
      ] },
    ],
  ...
  edge_archive: __table({
    name: 'edge_archive',
    indexes: [
      { name: 'archiveId', algorithm: 'btree', columns: [
        'archiveId',
      ] },
      { name: 'project_archived_at_idx', algorithm: 'btree', columns: [
        'projectId',
        'archivedAtUs',
      ] },
    ],
  ...
  edge_evidence: __table({
    name: 'edge_evidence',
    indexes: [
      { name: 'edge_id_idx', algorithm: 'btree', columns: [
        'edgeId',
      ] },
      { name: 'evidence_id_idx', algorithm: 'btree', columns: [
        'evidenceId',
      ] },
      { name: 'linkId', algorithm: 'btree', columns: [
        'linkId',
      ] },
    ],
    constraints: [
  ...
  evidence: __table({
    name: 'evidence',
    indexes: [
      { name: 'evidenceId', algorithm: 'btree', columns: [
        'evidenceId',
      ] },
      { name: 'project_source_id_idx', algorithm: 'btree', columns: [
        'projectId',
        'sourceId',
      ] },
      { name: 'project_source_kind_idx', algorithm: 'btree', columns: [
        'projectId',
        'sourceKind',
      ] },
    ],
  ...
  node: __table({
    ...
    indexes: [
      ...
      { name: 'project_kind_idx', algorithm: 'btree', columns: [
        'projectId',
        'kind',
      ] },
      { name: 'project_name_norm_idx', algorithm: 'btree', columns: [
        'projectId',
        'nameNorm',
      ] },
    ],
